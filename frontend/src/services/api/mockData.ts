...
export const mockParsedCV: ParsedCVData = {
  ...
  summary:
    "Experienced Full Stack Developer with 8+ years of expertise in building scalable web applications using React, Node.js, and Azure. Passionate about clean code, testing, and modern development practices.",
  experience: [
    {
      id: "exp1",
...
export const mockOptimizedCV: OptimizedCVData = {
  ...
  suggestions: [
    {
      ...
      suggested: "2020-03",
      reason:
        "Mix of date formats detected. Use YYYY-MM format consistently for better ATS parsing.",
    },
    {
      id: "sug2",
      type: "content",
      ...
      suggested:
        "Developed applications using React 18, TypeScript, and modern hooks",
      reason:
        "Include specific technology versions and tools mentioned in job descriptions.",
    },
  ],
  improvementAreas: [
    {
  ...
  keywordMatches: [
    ...
    { keyword: "TypeScript", found: true, importance: "high" },
    {
      ...
      found: false,
      importance: "medium",
      suggestion: "Add to skills or experience",
    },
...
export const mockJobMatch: JobMatchResult = {
  jobId: "job1",
  matchScore: 88,
  matchedSkills: ["React", "Node.js", "TypeScript", "Azure", "CI/CD"],
  missingSkills: [
  ...
  tailoredCV:
    "Your CV has been tailored to emphasize relevant experience with React, TypeScript, Azure, and microservices architecture. Consider adding specific examples of financial data handling if applicable.",
  recommendations: [
...
export const mockCareerInsights: CareerInsight = {
  skillDemand: [
    ...
    },
    {
      ...
      demand: "high",
      trend: "rising",
      relevantJobs: ["DevOps Engineer", "Cloud Architect"],
    },
    {
      skill: "Azure",
      demand: "high",
      trend: "rising",
      relevantJobs: ["Cloud Engineer", "Solutions Architect"],
    },
  ],
  salaryRange: {
    min: 60000,
